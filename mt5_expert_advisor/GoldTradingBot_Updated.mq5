...
int OnInit()
{
    ...
    Print("Gold Trading Bot v2.0 initialized successfully");
...
void UpdateAccountInfo()
{
    ...
    Comment(StringFormat("Balance: %.2f | Equity: %.2f | Margin: %.2f | Free: %.2f | Trades: %d | Trading: %s",
...
void InitializeWebSocket()
{
    ...
    string data = StringFormat("{\"symbol\":\"%s\",\"account\":\"%d\",\"server\":\"%s\"}", 
                              EA_Symbol, AccountInfoInteger(ACCOUNT_LOGIN), AccountInfoString(ACCOUNT_SERVER));
